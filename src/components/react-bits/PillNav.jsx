  ...
  useEffect(() => {
    const layout = () => {
      circleRefs.current.forEach((circle) => {
        ...
        if (white) {
          gsap.set(white, { y: h + 100, opacity: 0 });
  ...
  return (
    <div className="pill-nav-container">
      <nav className={`pill-nav ${className}`} style={cssVars}>
        <button className="pill-logo" onClick={() => scrollToSection("#")} onMouseEnter={handleLogoEnter} ref={logoRef}>
